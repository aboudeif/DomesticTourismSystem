...
INSERT INTO Travel (title,startDate,endDate,price)
			VALUES ('ÑÍáÉ Åáí ãÚÇáã ÇáÇÓßäÏÑíÉ','2021-07-11','2021-07-12',1200.0),
				   ...
				   ('ÑÍáÉ ãÊÇÍÝ ÇáÝä','2021-8-3','2021-8-5',3400.0),
				   ('ÇáÑÍáÉ ÇáÊÑÝíåíÉ Ã','2021-8-4','2021-8-4',1400.0),
				   ('ÑÍáÉ ÇáÔÑÞ æÇáÛÑÈ','2021-8-5','2021-8-6',7200.0),
				   ('ÇáÑÍáÉ ÇáÊÑÝíåíÉ Ì','2021-8-6','2021-8-8',2300.0),
				   ('ÑÍáÉ ÇáãÚÇáã ÇáÝÑÚæäíÉ','2021-8-7','2021-8-7',5500.0),
				   ('ÑÍáÉ ãÚÇáã ÇáÃÞÕÑ','2021-8-8','2021-8-8',1800.0),
				   ('ÑÍáÉ ÊÑÝíåíÉ È','2021-8-9','2021-8-10',2100.0),
				   ('ÑÍáÉ ãÏÑÓíÉ ãÌãÚÉ','2021-8-10','2021-8-13',790.0);
